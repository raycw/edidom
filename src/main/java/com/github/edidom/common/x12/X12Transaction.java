...
public class X12Transaction extends Envelope implements Transaction {
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#getGroupEnvelope()
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#getSegements()
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#getField(int)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#getType()
     */
	public String getType() {
		return getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#setType(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#getControlNumber()
     */
	public String getControlNumber() {
		return getField(2).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#setControlNumber(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.x12.Transaction#getSegments(java.lang.String)
     */
