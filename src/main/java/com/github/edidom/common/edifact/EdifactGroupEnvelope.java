...
public class EdifactGroupEnvelope extends Envelope implements GroupEnvelope{
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getInterchangeEnvelope()
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getField(int)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getTransactions()
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getFunctionalCode()
     */
	public String getFunctionalCode() {
		return getField(1).getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#setFunctionalCode(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getSenderCode()
     */
	public String getSenderCode() {
		return getField(2).getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#setSenderCode(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getReceiverCode()
     */
	public String getReceiverCode() {
		return getField(3).getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#setReceiverCode(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getControlNumber()
     */
	public String getControlNumber() {
		return getField(5).getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#setControlNumber(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getVersion()
     */
	public String getVersion() {
		return getField(8).getField(2).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#setVersion(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.GroupEnvelope#getSegment(java.lang.String)
     */
