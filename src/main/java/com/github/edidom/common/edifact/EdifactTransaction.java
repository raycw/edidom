...
public class EdifactTransaction extends Envelope implements Transaction {
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#getGroupEnvelope()
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#getSegements()
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#getField(int)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#getType()
     */
	public String getType() {
		return getField(2).getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#setType(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#getControlNumber()
     */
	public String getControlNumber() {
		return getField(1).getField(1).getValue().trim();
	}
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#setControlNumber(java.lang.String)
     */
	...
	/* (non-Javadoc)
     * @see com.github.edidom.common.Transaction#getSegments(java.lang.String)
     */
